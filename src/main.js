...
render(tripEventsElement, createFormEventEdit(), `beforeend`);
render(tripEventsElement, createTripDays(), `beforeend`);


const tripDaysElement = tripEventsElement.querySelector(`.trip-days`);
render(tripDaysElement, createTripDay(), `beforeend`);

const tripDayElement = tripEventsElement.querySelector(`.trip-days__item`);
render(tripDayElement, createTripEventsList(), `beforeend`);

const tripEventsListElement = tripDayElement.querySelector(`.trip-events__list`);

for (let i = 0; i < TRIP_EVENT_COUNT; i++) {
  render(tripEventsListElement, createTripEvent(), `beforeend`);
}
